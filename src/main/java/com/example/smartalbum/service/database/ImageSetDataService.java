...
public class ImageSetDataService {
     ...
     * @return 分页信息
     */
    public PageInfo<Image> getImageOutsideImageSet(int depositoryId, int imageSetId, int pageNum){

        Page<Object> objects = PageHelper.startPage(pageNum, 12);
        List<Image> imageUrls = getImageOutsideImageSet(depositoryId, imageSetId);
        objects.close();
